...
class HighlightOwnMessages : Plugin() {
    ...
    override fun start(context: Context) {
        ...
        with(WidgetChatListAdapterItemMessage::class.java) {
            patcher.patch(getDeclaredMethod("onConfigure", Int::class.java, ChatListEntry::class.java), Hook { callFrame -> 
                try {
                    ...
                    Utils.showToast("An error occurred while highlighting your message: ${e.message}")
                    logger.error(e)
                }
            })
        }
